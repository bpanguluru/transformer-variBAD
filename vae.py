...
class VaribadVAE:
    ...
    def initialise_encoder(self):
        ...
        # actually a transforemr for the time being
        encoder = TransformerEncoder(
            args=self.args,
            layers_before_transformer=self.args.encoder_layers_before_gru,
            layers_after_transformer=self.args.encoder_layers_after_gru,
            ...
            max_seq_len=self.args.max_trajectory_len
        ).to(device)
        return encoder
